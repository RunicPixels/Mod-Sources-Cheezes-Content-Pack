...
namespace CheezeMod.Items.Weapons.Ratchet
{
	public class UltraGoldWalloper : ModItem
	{
		public override void SetDefaults()
		{
            ...
            item.name = "Ultra Gold Walloper";
            item.width = 42;
            item.height = 42;
            item.useTime = 60;
            item.useAnimation = item.useTime;
            item.melee = true;
            item.toolTip = "'Fits like a golden glove and hits like a golden truck which inflicts Midas and Confusion'";
            item.toolTip2 = "Inspired by Ratchet and Clank.";
            item.scale = 0.8f;
			item.damage = 145;
            item.knockBack = 9f;
