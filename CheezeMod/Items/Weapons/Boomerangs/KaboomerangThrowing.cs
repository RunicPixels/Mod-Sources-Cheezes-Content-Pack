...
{
	public class KaboomerangThrowing : ModItem
	{
		public override void SetDefaults()
		{
            ...
            item.value = 10000;
            item.rare = 7;
			item.shoot = mod.ProjectileType("KaboomerangThrowing");
			item.shootSpeed = 12f;
		}

    public override void SetStaticDefaults()
    {
      DisplayName.SetDefault("Kaboomerang[Throwing]");
      Tooltip.SetDefault("A true lihzahrd has some explosive instincts.\nExplodes on hit, can stack up to 2 times.");
		...
		public override void AddRecipes()
		{
            ...
            recipe2.AddIngredient(null, "Kaboomerang");
