...
namespace CheezeMod.Items.Weapons.Thrown
{
    ...
    public override void SetStaticDefaults()
    {
      ...
      Tooltip.SetDefault("It has a tag on its handle which reads 'Fantaji', it's from a far eastern place.\nIt has a 10% chance to grant rage effect for 3 seconds on the player on enemy hit.");
    }
