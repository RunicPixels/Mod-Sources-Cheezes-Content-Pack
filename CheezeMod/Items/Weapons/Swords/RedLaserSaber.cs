...
{
	public class RedLasersaber : ModItem
	{
		public override void SetDefaults()
		{
            item.CloneDefaults(ItemID.BeamSword);
            item.name = "Red Lasersaber";
            item.toolTip = "Join the dark side, we have cookies!";
        ...
        {
            Lighting.AddLight(new Vector2(player.position.X, player.position.Y), 0.6f, 0f, 0f);
        }

        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            type = mod.ProjectileType("RedLaserArray");
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient("Red Phasesaber");
