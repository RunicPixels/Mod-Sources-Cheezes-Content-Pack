...
{
	public class PurpleLasersaber : ModItem
	{
        ...
        {
            Lighting.AddLight(new Vector2(player.position.X, player.position.Y), 0.6f, 0f, 0.6f);
        }

        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            type = mod.ProjectileType("PurpleLaserArray");
