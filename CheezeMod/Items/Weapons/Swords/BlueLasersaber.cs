...
{
	public class BlueLasersaber : ModItem
	{
		public override void SetDefaults()
		{
            item.CloneDefaults(ItemID.BeamSword);
            item.name = "Blue Lasersaber";
        ...
        {
            Lighting.AddLight(new Vector2(player.position.X, player.position.Y), 0f, 0f, 0.6f);
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient("Blue Phasesaber");
