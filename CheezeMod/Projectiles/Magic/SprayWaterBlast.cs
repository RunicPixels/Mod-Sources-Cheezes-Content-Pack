...
{
    public class SprayWaterBlast : ModProjectile
    {
        int bounceCount = 10;
        ...
        public override void AI()
        {
            ...
            {
                Dust.NewDust(projectile.position, projectile.width, projectile.height, 132, projectile.oldVelocity.X * 0.4f, projectile.oldVelocity.Y * 0.4f);
            }
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            Projectile.NewProjectile(projectile.position.X, projectile.position.Y, projectile.oldVelocity.X * -0.25f, projectile.oldVelocity.Y * -0.25f, ProjectileID.WaterStream, projectile.damage / 4, projectile.knockBack / 2, projectile.owner);
        }
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            ...
            else
            {
                ...
                Projectile.NewProjectile(projectile.position.X, projectile.position.Y, projectile.oldVelocity.X * -0.25f, projectile.oldVelocity.Y * -0.25f, ProjectileID.WaterStream, projectile.damage / 3, projectile.knockBack / 2, projectile.owner);
                bounceCount--;
            }
            return false;
        }
