...
{
    public class MegaNuke : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("Mega Nuke");
        }
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            target.AddBuff(mod.BuffType("Radiation"), 300);
            if (canExplode)
            {
                explode();
            }
        ...
        public void explode()
        {
            ...
            int gore1 = Gore.NewGore(new Vector2(projectile.position.X-25, projectile.position.Y-195) - projectile.Size, new Vector2(0, 0), mod.GetGoreSlot("Gores/Explosions/MegaNuke"));
            ...
            Lighting.AddLight(projectile.position, 1.5f, 2.2f, 1f);
