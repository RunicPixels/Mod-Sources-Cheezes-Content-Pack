...
namespace CheezeMod.Projectiles.Thrown
{
    public class PlatinumKunai : ModProjectile
    {
        public override void SetDefaults()
        {
            ...
            projectile.name = "Platinum Kunai";
            projectile.width = 14;
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType("PlatinumKunai"));
            }
