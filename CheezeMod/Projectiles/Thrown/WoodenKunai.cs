...
{
    public class WoodenKunai : ModProjectile
    {
        public override void SetDefaults()
        {
            projectile.CloneDefaults(ProjectileID.ThrowingKnife);
            projectile.name = "Wooden Kunai";
            projectile.width = 14;
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType("WoodenKunai"));
            }
