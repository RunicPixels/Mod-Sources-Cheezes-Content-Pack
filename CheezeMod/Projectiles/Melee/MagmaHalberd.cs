...
{
	public class MagmaHalberd : ModProjectile
	{
		public override void SetDefaults()
		{
			projectile.name = "MagmaHalberd";
			projectile.width = 20;
		...
		public override void AI()
        {
            ...
            Lighting.AddLight(new Vector2(projectile.position.X, projectile.position.Y), 0.5f, 0.3f, 0.0f);
